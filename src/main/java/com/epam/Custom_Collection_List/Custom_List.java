...
public class Custom_List 
{
    public static void main( String[] args )
    {
        ...
        arraylist.add("Yamini Podugu");
        arraylist.add("Sree Vidya");
        arraylist.add("Vaishnavi");
        arraylist.add("Shravani");
        arraylist.add("Niharika Parki");
        arraylist.add("Jyothirmayee");
        arraylist.add("Sampurna");
        arraylist.add("Navya");
        arraylist.add("Niharika Kamatam");
        arraylist.add("Shethala");
        ...
        for(String s:arraylist)
        	System.out.print(s+" ");
        System.out.println();
        System.out.println(arraylist.contains("Yamini"));
        System.out.println(arraylist.contains("Yamini Podugu"));
        for(String s:arraylist)
        	System.out.println(s);
        arraylist.remove(3);
        System.out.println(arraylist.remove(4));
        System.out.println(arraylist.remove("Shethala"));
        arraylist.add(5,"Neha");
        System.out.println(arraylist);
        System.out.println(arraylist.size());
